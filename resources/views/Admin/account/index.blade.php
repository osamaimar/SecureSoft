@extends('Admin/partials/master',['title'=>'Profile'])


@section('content')
@include("Admin/partials/page-header", ["title"=> "Profile", "subtitle"=> 'Ecommerce', 'subtitle2'=>'Profile'])
                ...
                <div class="d-sm-flex align-items-top p-4 border-bottom-0 main-profile-cover">
                    ...
                    <div class="flex-fill main-profile-info">
                        <div class="d-flex align-items-center justify-content-between">
                            <h6 class="fw-semibold mb-1 text-fixed-white">{{Auth::guard('admin')->user()->first_name.' '.Auth::guard('admin')->user()->last_name}}</h6>
                        </div>
