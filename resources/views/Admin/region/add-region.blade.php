...
<div class="card-body">
    <div class="table-responsive mb-4">
        <table class="table text-nowrap table-bordered">
            ...
            <tbody>
                @foreach (App\Models\Region::paginate(10) as $region)
                <tr class="product-list">
                    <td class="product-checkbox"><input class="form-check-input" type="checkbox" name="regions[]" id="product1" value="" aria-label="..."></td>
                    <td>
                        <span class="badge bg-light text-default">{{$region->id}}</span>
                    </td>
                    <td>
                    ...
                    <td>{{$region->products->count()}}</td>
                    <td>
                        <div class="hstack gap-2 fs-15">
                            <form method="GET" action="{{route('admin.regions.edit',$region)}}">
                                @csrf
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                @else
                <li class="page-item">
                    <a class="page-link" href="{{ $regions->previousPageUrl() }}" rel="prev">Previous</a>
                </li>
                @endif

                <!-- Pagination Elements -->
                @foreach ($regions->links()->elements as $element)
                ...
                <li class="page-item">
                    <a class="page-link" href="{{ $regions->nextPageUrl() }}" rel="next">Next</a>
                </li>
                @else
                <li class="page-item disabled">
