@extends('Admin/partials/master',['title'=>'Edit Merchant'])


@section('content')
@include("Admin/partials/page-header", ["title"=> "Edit Merchant", "subtitle"=> 'Ecommerce', 'subtitle2'=>'Edit Merchant'])
            ...
            <div class="card-body p-0">
                <div class="d-sm-flex align-items-top p-4 border-bottom-0 main-profile-cover">
                    ...
                    <div class="flex-fill main-profile-info">
                        <div class="d-flex align-items-center justify-content-between">
                            <h6 class="fw-semibold mb-1 text-fixed-white">{{$merchant->first_name.' '.$merchant->last_name}}</h6>
                        </div>
                        <p class="mb-1 text-muted text-fixed-white op-7">Merchant</p>
                    </div>
                </div>
                <div class="p-4 border-bottom border-block-end-dashed">
                    ...
                    <div class="text-muted">
                        ...
                        <p class="mb-2">
                            <span class="avatar avatar-sm avatar-rounded me-2 bg-light text-muted">
                                <i class="ri-building-4-line align-middle fs-14"></i>
                            </span>
            ...
            <div class="col-xl-12">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <form method="post" action="{{ route('admin.profile.update') }}" class="mt-6 space-y-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="first_name" value="{{$merchant->first_name}}" class="form-control" id="form-text" placeholder="">
                                        @error('first_name')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="last_name" value="{{$merchant->last_name}}" class="form-control" id="form-text" placeholder="">
                                        @error('last_name')
                                        <label for="product-name-add" class="form-label mt-1 fs-12 op-5 text-danger mb-0">{{ $message }}</label>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="email" value="{{$merchant->email}}" class="form-control" id="form-text" placeholder="">
                                        @error('email')
                                        <label for="product-name-add" class="form-label mt-1 fs-12 op-5 text-danger mb-0">{{ $message }}</label>
                                        @enderror


                                        @if ($merchant instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $merchant->hasVerifiedEmail())
                                        <div>
                ...
                <div class="card custom-card mb-3">
                    <div class="card-body p-0 ">
                        ...
                        <div class="p-3">
                            <div class="tab-content" id="myTabContent">
                                <form method="post" action="{{ route('admin.merchant.password.update',$merchant->id) }}" class="mt-6 space-y-6">
                                    @csrf
                                    @method('PATCH')
                                    <div>
