@extends('Admin/partials/master',['title'=>'Edit Invoice'])


@section('content')
@include("Admin/partials/page-header", ["title"=> "Edit Invoice", "subtitle"=> 'Ecommerce', 'subtitle2'=>'Edit Invoice'])
<div class="row">
    <div class="col-xl-9">
            ...
            <div class="card-header d-md-flex d-block">
                <div class="h5 mb-0 d-sm-flex d-block align-items-center">
                    ...
                    <div class="ms-sm-2 ms-0 mt-sm-0 mt-2">
                        <input type="text" class="form-control form-control-light form-control-sm" placeholder="Invoice ID" value="{{$invoice->id}}">
                    </div>
                    <div class="mx-2">:</div>
                    <div class="mt-sm-0 mt-2">
                        <input type="text" class="form-control form-control-light form-control-sm" placeholder="Invoice Number" value="{{$invoice->invoice_number}}">
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="row gy-3">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 ms-auto mt-sm-0 mt-3">
                                ...
                                <div class="row gy-2">
                                    <div class="col-xl-12">
                                        ...
                                        <input type="text" class="form-control form-control-light" id="customer-Name" placeholder="Customer Name" value="{{$invoice->order->user->first_name.' '.$invoice->order->user->last_name}}">
                                        @else
                                        <input type="text" class="form-control form-control-light" id="customer-Name" placeholder="Customer Name" value="{{$invoice->order->merchant->first_name.' '.$invoice->order->merchant->last_name}}">
                                    ...
                                    @if ($invoice->order->user)
                                        ...
                                        @else
                                        <textarea class="form-control form-control-light" id="customer-address" placeholder="Enter Address" rows="3">{{$invoice->order->merchant->address}}</textarea>
                                        @endif
                                    </div>
                                    <div class="col-xl-12">
                                    @if ($invoice->order->user)
                                        <input type="text" class="form-control form-control-light" id="customer-mail" placeholder="Customer Email" value="{{$invoice->order->user->email}}">
                                        @else
                                        <input type="text" class="form-control form-control-light" id="customer-mail" placeholder="Customer Email" value="{{$invoice->order->merchant->email}}">
                                        @endif
                                    </div>
                                    <div class="col-xl-12">
                                    @if ($invoice->order->user)
                                        <input type="text" class="form-control form-control-light" id="customer-phone" placeholder="Phone Number" value="{{$invoice->order->user->phone_number}}">
                                        @else
                                        <input type="text" class="form-control form-control-light" id="customer-phone" placeholder="Phone Number" value="{{$invoice->order->merchant->First_Phone_number}}">
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3">
                        ...
                        <input type="text" class="form-control form-control-light" id="invoice-number" placeholder="Inv No" value="#{{$invoice->invoice_number}}">
                    </div>
                    <div class="col-xl-3">
                        <label for="invoice-date-issued" class="form-label">Date Issued</label>
                        <input type="date" class="form-control" id="input-date" value="{{$invoice->created_at->format('Y-m-d')}}">
                    </div>
                    <div class="col-xl-3">
                        <label for="invoice-date-due" class="form-label">Due Date</label>
                        <input type="date" class="form-control" id="input-date" value="{{$invoice->due_date}}">
                    </div>
                    <div class="col-xl-3">
                        <label for="invoice-due-amount" class="form-label">Due Amount</label>
                        <input type="text" class="form-control form-control-light" id="invoice-due-amount" placeholder="Enter Amount" value="${{$invoice->total}}">
                    </div>
                    <div class="col-xl-12">
