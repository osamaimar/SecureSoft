        ...
        <div class="header-content-right mb-0">
            ...
            <div class="header-element cart-dropdown">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
                    <span class="badge bg-primary rounded-pill header-icon-badge" id="cart-icon-badge">
                        {{Auth::guard()->user()->cart->number_of_products}}
                    </span>
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    <div class="p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <span class="badge fs-12 bg-success-transparent" id="cart-data">Total: {{Auth::guard()->user()->cart->total_amount}}$</span>
                        </div>
                    </div>
                    <div>
                    ...
                    <ul class="list-unstyled mb-0" id="header-cart-items-scroll">
                        @foreach (Auth::guard()->user()->cart->products as $product)
                            ...
                            <div class="d-flex align-items-start cart-dropdown-item">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-start justify-content-between mb-0">
                                        ...
                                        <div>
                                            <span class="text-black mb-1">${{$product->min_partner_price}}</span>
                                            <form method="POST" class="d-inline-block p-0 m-0" action="{{route('merchant.cart.delete',$product)}}">
                                                @csrf
                                                @method('DELETE')
                                    ...
                                    <div class="min-w-fit-content d-flex align-items-start justify-content-between">
                                        <ul class="header-product-item d-flex">
                                            <li>Qtn: <input type="number" class="form-control d-inline-block form-control-sm" style="width: 40%;" id="product-quantity-{{ $product->id }}" value="{{ $product->pivot->quantity }}" data-product-id="{{ $product->id }}" disabled>
                                                <label class="form-label mt-1 fs-11 op-5 mb-0 ">In Stock: {{$product->stock}}</label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        @endforeach
                        @if (Auth::guard()->user()->cart->products->isEmpty())
                        <li class="dropdown-item">
                    ...
                    @if (Auth::guard()->user()->cart->products()->count()>0)
                    <div class="p-3 empty-header-item border-top">
                        <div>
                            <form method="GET" action="{{route('merchant.checkout.form',Auth::guard()->user()->cart)}}">
                                @csrf
            ...
            <div class="header-element">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-sm-block d-none">
                            <p class="fw-semibold mb-0 lh-1">{{Auth::guard('merchant')->user()->first_name}} {{Auth::guard('merchant')->user()->last_name}}</p>
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                    <li><a href="{{route('merchant.profile.edit')}}" class="dropdown-item d-flex" href="profile.html"><i class="ti ti-user-circle fs-18 me-2 op-7"></i>Profile</a></li>
