@extends('Merchant/partials/master',['title'=>'Profile'])


@section('content')
@include("Merchant/partials/page-header", ["title"=> "Profile", "subtitle"=> 'Ecommerce', 'subtitle2'=>'Profile'])
                ...
                <div class="d-sm-flex align-items-top p-4 border-bottom-0 main-profile-cover">
                    <div>
                        <span class="avatar avatar-xxl avatar-rounded online me-3">
                            <img src="../assets/images/faces/22.png" alt="">
                        </span>
                    </div>
                    ...
                    <div class="card-body p-0 ">
                        ...
                        <div class="p-3">
                            <div class="tab-content" id="myTabContent">
                                <form method="post" action="{{route('merchant.profile.update')}}" class="mt-6 space-y-6">
                                    @csrf
                                    <div class="mb-3">
                        ...
                        <div class="p-3">
                            <div class="tab-content" id="myTabContent">
                                <form method="post" action="{{ route('merchant.password.update') }}" class="mt-6 space-y-6">
                                    ...
                                    <div>
                                        <label for="form-text" class="form-label fs-14 text-dark">Current Password</label>
                                        <input type="password" name="current_password" class="form-control" id="form-text" placeholder="">
