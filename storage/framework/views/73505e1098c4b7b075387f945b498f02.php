            ...
            <div class="card-body d-flex">
                ...
                <div>
                    ...
                    <div class="border border-dark d-inline-block mt-5 ms-3 p-2 pb-0">
                        <h6 class="d-inline-block align-items-center justify-content-between">Partner Price : <?php echo e($product->min_partner_price); ?>$</h6>
                    </div><br>
                    <div class="d-inline-block  mt-3 ms-3 p-1" style="background-color: #025E2F;">
                        <p class="  p-0 m-0 text-light fw-semibold">End User Price(MSRP) : <?php echo e($product->end_user_price); ?>.00 $</p>
                    </div>
                </div>
            </div>
            ...
            <div class="containe ">
                ...
                <div class="tab-content">
                    <div id="home" class="container tab-pane active rounded-0"><br>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 d-inline-block me-1">
                                ...
                                <input type="number" name="test_unit_price" class="form-control rounded-0" id="unit-price-input" placeholder="Number" min="1" value="<?php echo e($product->min_partner_price); ?>.00" disabled>
                            </div>
                    ...
                    <div id="menu1" class="container tab-pane fade rounded-0"><br>
                        <ul>
                            <li>You can keep licenses on stock, <?php echo e($product->warranty); ?>.</li>
                            <li>Warranty of originality And functionality, <?php echo e($product->warranty); ?> Gold.</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12">
        <div class="card custom-card product-card rounded-0">
            <div class="card-body ">
                ...
                <form method="POST" action="<?php echo e(route('merchant.cart.add',$product)); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="d-block mt-4">
                        ...
                        <?php $__errorArgs = ['terms-checkbox'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php $__errorArgs = ['region-checkbox'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 d-inline-block me-1">
                                <label for="input-number" class="form-label">Quantity</label>
                                <input type="number" name="quantity" class="form-control rounded-0" value="1" id="quantity-input2" placeholder="Number" min="1" max="<?php echo e($product->stock); ?>">
                            </div>

                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 d-inline-block me-1">
                                <label for="input-number" class="form-label">Unit Price</label>
                                <input type="number" name="unit_price" class="form-control rounded-0" id="unit-price-input2" placeholder="Number" min="1" value="<?php echo e($product->min_partner_price); ?>.00" disabled>
                            </div>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <label for="product-name-add" class="form-label mt-1 fs-12 op-5 text-danger mb-0 d-block"><?php echo e($message); ?></label>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        <label class="form-label mt-1 fs-12 op-5 mb-0 d-block">In Stock: <?php echo e($product->stock); ?></label>


                        <button type="submit" class="btn btn-primary-light rounded-0 mt-3 border border-primary d-block" <?php echo e($product->stock <= 0 ? 'disabled' : ''); ?>>Add to Cart</button>
                ...
                <?php endif; ?>
                <?php if($product->stock <= 0): ?> <h5 class="text-danger  mt-1">Out of Stock</h5>
                    <?php endif; ?>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('Merchant/partials/master',['title'=>'Dashboard'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/osamahamar/Desktop/Codes/SecureSoft Solutions/SecureSoft/resources/views/Merchant/product/product-details.blade.php ENDPATH**/ ?>