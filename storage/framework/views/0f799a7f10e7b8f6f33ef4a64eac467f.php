...
<?php elseif(session()->has('purchase')): ?>
<div class="toast-container position-fixed top-0 end-0 p-3">
    <div id="purchase-Toast" class="toast colored-toast bg-secondary-transparent" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header bg-secondary text-fixed-white">
            <img class="bd-placeholder-img rounded me-2" src="<?php echo e(asset(App\Models\Settings::first()->dark_icon)); ?>" alt="...">
...
<?php elseif(session()->has('favorite')): ?>
<div class="toast-container position-fixed top-1 end-0 p-3">
    <div class="alert alert-warning alert-dismissible shadow-sm toast d-flex align-items-center" aria-live="assertive" aria-atomic="true" id="favorite-Toast" role="alert" style="background-color: rgb(254,248,238); border-color: rgb(254,244,227);">
        ...
        <div><?php echo e(session('favorite')); ?></div>
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x text-right"></i></button>
    </div>
</div>
...
<audio id="successSound">
    <source src="<?php echo e(asset('/assets/sounds/success.mp3')); ?>" type="audio/mpeg">
</audio>
<audio id="purchaseSound">
    <source src="<?php echo e(asset('/assets/sounds/purchase.mp3')); ?>" type="audio/mpeg">
</audio>
<audio id="warningSound">
    <source src="<?php echo e(asset('/assets/sounds/error.mp3')); ?>" type="audio/mpeg">
</audio>
<audio id="deleteSound">
    <source src="<?php echo e(asset('/assets/sounds/delete.mp3')); ?>" type="audio/mpeg">
</audio>
...
</script><?php /**PATH /Users/osamahamar/Desktop/Codes/SecureSoft Solutions/SecureSoft/resources/views/Merchant/partials/sounds.blade.php ENDPATH**/ ?>